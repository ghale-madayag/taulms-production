<template>
    ...
    <div class="container page__container">
        <div class="page-section d-flex flex-column flex-sm-row align-items-sm-center">
            <div class="flex">
                <Link href="/faculty" class="h-auto"><i class="material-icons icon--left">keyboard_backspace</i> Back</Link>
            ...
            <div class="col-lg-6 p-0">
                    ...
                    <div class="d-flex flex-wrap align-items-start">
                        ...
                        <div class="flex" style="min-width: 180px">
                            <small class="text-black-100">
                                <strong>Success!</strong> The email was successfully added. Please verify the email
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit">
                    <div class="form-group">
                        <label class="form-label" for="email">Please enter {{ user.lname }} email address</label>
